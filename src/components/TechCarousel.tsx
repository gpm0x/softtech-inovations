  ...
  return (
    <section className="py-20 bg-gradient-to-br from-slate-800 to-slate-900">
      <div className="container mx-auto px-6">
        ...
        {/* Carousel para as tecnologias */}
        <div className="max-w-6xl mx-auto">
          <Carousel className="w-full">
            <CarouselContent>
              {technologies.map((tech, index) => (
                <CarouselItem key={tech.name} className="md:basis-1/3 lg:basis-1/6">
                  <div className="group bg-slate-700/50 backdrop-blur-sm rounded-2xl p-6 text-center hover:bg-slate-600/50 transition-all duration-300 hover:-translate-y-2 border border-slate-600/50">
          ...
          <div className="flex justify-center mt-8 space-x-2 md:hidden">
            {Array.from({ length: Math.ceil(technologies.length / 2) }, (_, index) => (
              <div
                key={index}
