        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center animate-slide-up" style={{animationDelay: '0.2s'}}>
            <a
              ...
              className="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg inline-flex items-center justify-center gap-3"
            >
              💬 Fale Conosco no WhatsApp
            </a>
            <a
              href="mailto:contato@softtech.com"
              className="bg-transparent border-2 border-blue-400 text-blue-300 hover:bg-blue-400 hover:text-slate-900 font-semibold px-8 py-4 rounded-xl transition-all duration-300 inline-flex items-center justify-center gap-3"
            >
              📧 Enviar Email
            </a>
          </div>
